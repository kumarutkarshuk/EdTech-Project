//Imp: Check out how ternary operator can be used inside parenthesis
...
const Signup = () => {
    ...
    const submitHandler = (e) => {
        ...
        //this is not working
        // if(typeof formData.contactNumber !== 'number'){
        ...
        return (
            <div className='w-11/12 mx-auto flex text-white justify-evenly mt-[5%] gap-14' onSubmit={submitHandler}>
                ...
                <div className='flex flex-col gap-4 w-[40%]'>
                    ...
                    <form className='flex flex-col gap-4'>
                        ...
                        <div className='flex flex-col gap-2'>
                            <label htmlFor="contactNumber code">Phone Number<sup className='text-pink-300'>*</sup></label>
        
                            <div className='flex justify-between gap-2'>
                                <select className='bg-richblack-800 rounded-md border-b-[1px] border-[#FFFFFF2E] text-center
                                w-[50%] text-richblack-200 px-2' id='code' onChange={formDataHandler}>
                                    {
                                ...
                                focus:outline-none w-full' id='contactNumber' onChange={formDataHandler} required/>
                            </div>
                        ...
                        border-[#FFFFFF2E] border-b-2 border-r-2 hover:scale-95 mb-10 mt-2'>
